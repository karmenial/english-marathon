/*
══════════════════════════════════════════════════════╗
║   نوع النسخة: أوفلاين (بيانات تجريبية)             ║
║  📍 الاستخدام: جهازك المحلي فقط                     ║
║  📅 آخر تعديل: 2026-07-02                           ║
║                                                      ║
║  ⚠️ عند الرفع على GitHub:                           ║
║     استبدل هذا الملف بنسخة الأونلاين (fetch JSON)   ║
╚══════════════════════════════════════════════════════╝
*/
...
const MOCK_DB = {
    users: [
        { id: 't1', role: 'teacher', name: 'أحمد محمد', email: 'ahmed@teacher.com', pass: '123', commission: 15, phone: '01012345678', joinDate: '2026-01-15' },
        { id: 's1', role: 'student', name: 'محمد علي', email: 's1@t.com', pass: '123', level: 'primary', grade: '4', type: 'AL', teacherId: 't1', isPaid: true, joinDate: '2026-06-01', duration: 30 },
        { id: 's2', role: 'student', name: 'سارة حسن', email: 's2@t.com', pass: '123', level: 'primary', grade: '4', type: 'AL', teacherId: 't1', isPaid: true, joinDate: '2026-05-15', duration: 30 },
        { id: 's3', role: 'student', name: 'خالد عمر', email: 's3@t.com', pass: '123', level: 'primary', grade: '4', type: 'AL', teacherId: 't1', isPaid: false, joinDate: '2026-04-01', duration: 30 },
        { id: 's4', role: 'student', name: 'نور أحمد', email: 's4@t.com', pass: '123', level: 'primary', grade: '5', type: 'OL', teacherId: 't1', isPaid: true, joinDate: '2026-06-20', duration: 30 }
    ],
    teacherExams: [
        { id: 'e1', teacherId: 't1', title: 'Unit 1 Exam - Grade 4', level: 'primary', grade: '4', type: 'AL', unit: '1', url: 'https://example.com/exam1', addedDate: '2026-06-10' },
        { id: 'e2', teacherId: 't1', title: 'Unit 2 Quiz - Grade 5', level: 'primary', grade: '5', type: 'OL', unit: '2', url: 'https://example.com/exam2', addedDate: '2026-06-25' }
    ]
};
...
// ==========================================
// 📥 1. تحميل البيانات (أوفلاين - بيانات تجريبية)
// ==========================================
function loadPartnersData() {
    // في الأوفلاين: نستخدم البيانات التجريبية مباشرة
    usersDB = MOCK_DB;
    console.log('📦 تم تحميل البيانات التجريبية للأوفلاين');
}
...
function handleLogin(e) {
    e.preventDefault();
    loadPartnersData(); // تحميل البيانات التجريبية
